...
public class Candidate {
    ...
    public Candidate(int Candidate_Id, String name, int aptitude,
    ...
    public static void main(String[] args) {
        ...
        // 2. Smaller Candidate ID first when scores are equal
        ...
        for (int i = 0; i < N - 1; i++) {
            ...
            for (int j = i + 1; j < N; j++) {
                ...
                if (score2 > score1 ||
                    (score2 == score1 &&
                     candidates[j].Candidate_Id < candidates[i].Candidate_Id)) {
